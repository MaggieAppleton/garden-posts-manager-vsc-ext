...
export class StatisticsProvider implements vscode.TreeDataProvider<StatisticsItem | LoadingTreeItem> {
	...
	> = new vscode.EventEmitter<StatisticsItem | LoadingTreeItem | undefined | null | void>();
	 ...
	 */
	getChildren(element?: StatisticsItem | LoadingTreeItem): Thenable<(StatisticsItem | LoadingTreeItem)[]> {
		if (!element) {
